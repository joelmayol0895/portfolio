  ...
  return (
    <section id="skills" className='bg-background-secondary'>
      <div className='container min-h-auto flex flex-col items-center justify-center p-5 md:p-20 text-center space-y-9'>
          <h2 className='text-2xl md:text-4xl font-bold tracking-tight mb-7'>My <span className='text-primary'>Skills</span></h2>
          <div className='w-full'>
            <h3 className='text-2xl md:text-3xl font-semibold mb-5'><span className='text-primary-foreground'>Essential Tools</span> that I'm using</h3>
            <p className="text-[14px] sm:text-[16px]">Discover the powerful tools and technologies I use to create exceptional, high-performing websites & application</p>
          </div>
