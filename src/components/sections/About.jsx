...
const About = () => {
  ...
  return (
    <section id='about' className='bg-background-secondary'>
      <div className='container min-h-screen flex flex-col items-center justify-center py-15 md:p-20 text-center space-y-9'>
        <h2 className='text-[9vw] sm:text-[8vw] md:text-[45px] font-bold tracking-tight mb-7 text-secondary-foreground'>About <span className='text-primary'>Me</span></h2>
